                  ...
                  Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: widget.closIcon? MainAxisAlignment.spaceBetween : MainAxisAlignment.center,
                          children: [
                            widget.closIcon ? SizedBox(width: 25,) : Container(),
                            const Text(
                              'WHISKERS PREMIUM',
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.bold),
                            ),
                            widget.closIcon? InkWell(
                              child: const Icon(
                                Icons.close,
                                color: Colors.black,
                                size: 25,
