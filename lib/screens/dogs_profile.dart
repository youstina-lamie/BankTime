...
import 'package:whiskers/screens/more.dart';
import 'package:whiskers/screens/more_screen/add_dog_profile.dart';
                                ...
                                return Column(
                                  children: [
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            SizedBox(
                                              ...
                                              child: DropdownButtonHideUnderline(
                                                child: DropdownButton2<Dog>(
                                                  ...
                                                  items: dogsListing.map((Dog lst) {
                                                    return DropdownMenuItem<Dog>(
                                                        value: lst,
                                                        child: Container(
                                                          width: double.infinity,
                                                          decoration: (lst.name == 'Add New Dog')
                                                              ? const BoxDecoration()
                                                              : const BoxDecoration(
                                                                  border: Border(
                                                                      bottom: BorderSide(
                                                  ...
                                                  onChanged: (value) async {
                                                    if (value!.name == "Add New Dog") {
                                                      Navigator.of(context)
                                                          .push(CustomPageRoute(child: const AddDogProfileScreen()));
                                                    } else {
                                                      setState(() {
                                                        loading = true;
                                                        var _newSelectedDog = value;
                                                        dogSelected = _newSelectedDog;
                                                        globals.currentDog = dogSelected;
                                                        dogSelectedPro = dogSelected;
                                                      });
                                                      Provider.of<globals.DogSelectedProvider>(context, listen: false)
                                                          .changeDogSelected(dogSelectedPro!);
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () {
                                                Navigator.of(context).push(CustomPageRoute(child: const MoreScreen()));
                                              },
                                            ),
                                          ],
                                        ),
                                    ...
                                    Container(
                                        ...
                                        decoration: const BoxDecoration(color: Color.fromRGBO(169, 58, 139, 1)),
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration:
                                                  dogSelected!.image != null && dogSelected!.image!.originalUrl != ''
                                                      ? BoxDecoration(
                                                          shape: BoxShape.circle,
                                                          border: Border.all(width: 3.0, color: Colors.white))
                                                      : const BoxDecoration(),
                                              child: dogSelected!.image != null && dogSelected!.image!.originalUrl != ''
                                                  ? ClipRRect(
                                              ...
                                              onTap: () {
                                                Navigator.of(context).push(CustomPageRoute(
                                                  ...
                                                  callBack: (dog) {
                                                    ...
                                                    dogsListing[dogsListing.indexOf(dogSelected!)] = dog;
                                                    dogSelected = dog;
                                                    setState(() {});
                                                  },
                                                )));
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          ToggleSwitch(
                                            ...
                                            fontSize: 14.0,
                                            initialLabelIndex: 0,
                                            activeBgColor: [const Color.fromRGBO(19, 140, 237, 1)],
                                            activeFgColor: Colors.white,
                                            inactiveBgColor: Colors.white,
                                            borderWidth: 1.0,
                                            borderColor: [const Color.fromRGBO(19, 140, 237, 1)],
                                            inactiveFgColor: const Color.fromRGBO(19, 140, 237, 1),
                                            totalSwitches: 3,
                                            dividerColor: const Color.fromRGBO(19, 140, 237, 1),
                                            labels: [dogSelected!.name, 'Difficulty', 'Status'],
                                            onToggle: (i) {
                                              // if (i != index) {
                                              //   setState(() {
                                              //     index == i;
                                              ...
                                              ? Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: const BoxDecoration(
                                                      border: Border(
                                                        bottom:
                                                            BorderSide(width: 1, color: Color.fromRGBO(19, 140, 237, 1)),
                                                      ),
                                                    ),
                                                    child: Row(
                                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  child: coursesForDog[index].freePremium == 1
                                                                      ? Icon(
                                                                          Icons.lock_rounded,
                                                          ...
                                                          SizedBox(
                                                            child: DropdownButtonHideUnderline(
                                                              child: DropdownButton<Status>(
                                                                ...
                                                                value: coursesForDog[index].status,
                                                                icon: const Icon(
                                                                ...
                                                                onChanged: (value) async {
                                                                  if (value != coursesForDog[index].status) {
                                                                    if (value!.id == 1) {
                                                                      startedCourse -= 1;
                                                                    }
                                                                    if (value.id != 1 &&
                                                                        coursesForDog[index].status!.id == 1) {
                                                                      startedCourse += 1;
                                                                    }
                                                                    setState(() {
                                                                      startedCourse = startedCourse;
                                                                      coursesForDog[index].status = value;
                                                                    });
                                                                    await Shared(context).post("course/update-status", {
                                                                      'status_id': (value.id).toString(),
                                                                      'dog_id': (dogSelected!.id).toString(),
                                                                      'course_id': (coursesForDog[index].id).toString()
                                                                    });
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          SizedBox(width: MediaQuery.of(context).size.width * 0.8, child: Container()),
                                          InkWell(
                                            child: const Icon(
                                              Icons.settings,
                                              color: Colors.white,
  ...
  Future<List<Dog>> fetchDogs() async {
    try {
      ...
      if (count != 1) {
        ...
        List<Status> statusData = ((jsonDecode(responseStatus.body)['coursesStatuses']) as List)
        ...
        Response coursesResponse = await Shared(context).get("courses/for-dog/${dogSelected!.id}");
        var coursesjson = jsonDecode(coursesResponse.body);

        coursesForDog = (coursesjson['courses'] as List).map((course) => Course.fromJson(course)).toList();
